...
\begin{enumerate}
	...
	\item In real code, you should avoid reimplementing common functions such as this.  Find a standard Python implementation online and change your \shellcmd{transpose()} function to call it instead.  Writing small functions that simply call libraries can be useful: if at a later date you found a better third party library, the changes required to your code are minimal.  What other benefits does this approach bring? % lets you write functions that are more meaningful to your code; convenient place to add logging/other hooks; easier to write automated tests
\end{enumerate}
\end{exercise}
