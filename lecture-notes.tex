...
\begin{enumerate}
	\item For the numeric integration program you wrote in Practical~\TODO{xref}, plot how the accuracy versus $\Delta x$.  What can you conclude from this plot?
...
\begin{itemize}
	\item List comprehensions provide a succinct method for transforming and filtering list data.
\end{itemize}
